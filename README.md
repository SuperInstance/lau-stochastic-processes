...
Stochastic processes library: random walks, martingales, Brownian motion, Poisson processes, Markov chains, Itô calculus, Ornstein-Uhlenbeck, and agent behavioral modeling
...
```bash
git clone https://github.com/SuperInstance/lau-stochastic-processes
cd lau-stochastic-processes
```
